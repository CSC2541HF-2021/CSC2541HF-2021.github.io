...
var classes_txt = ['normal', 'pneumonia'];
...
var start_convnet_demo = function() {
  // load test batch of pneumonia dataset
  load_from_json();
  load_data_batch();
}

// Load test data batch of 50 images from pneumonia dataset
var img_data = null;
var load_data_batch = function() {
  ...
  data_img_elt.src = "convnet_demo/pneumonia_batch_50_small.png";
}
...
var sample_instance = function() {
  ...
  var p = img_data.data;
  var x = new convnetjs.Vol(64,64,3,0.0);
  var W = 64*64;
  var j=0;
  for(var dc=0;dc<3;dc++) {
    var i=0;
    for(var xc=0;xc<64;xc++) {
  ...
  for(var q=0;q<num_test_samples;q++) {
    ...
    xs.push(convnetjs.augment(x, 64, dx, dy, q>=d2));
  }
